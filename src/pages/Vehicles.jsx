      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        {loading ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {vehicles.map((v, i) => (
              <Card key={v.id} className="group overflow-hidden rounded-lg border-slate-200 bg-white card-hover fade-up" style={{ animationDelay: `${i * 50}ms` }} data-testid={`vehicle-card-${v.id}`}>
